...
## Architecture Diagram
   ...
   ![Architecture Diagram](images/lab3-architecture1.png)
...
3. On the **MS Hosted CI/CD (1)** section under **Paid parallel jobs** enter value **1** and at the end of the page click on **Save (2)**.
