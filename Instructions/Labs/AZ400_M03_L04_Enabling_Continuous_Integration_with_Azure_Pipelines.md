...
In this task, you will create an **eShopOnWeb** Azure DevOps project to be used by several labs.
   ...
   1. On your lab computer, in a browser window open your Azure DevOps organization. Click on **New Project**. Give your project the name  **eShopOnWeb (1)**, select visibility as **Private(3)**  and leave the other fields with defaults. Click on **Create project (3)**.
